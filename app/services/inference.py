...
class SBERTModel:
    ...
    def _build_architecture(self):
        ...
        # Konfigurasi freeze persis seperti saat training
    ...
    def predict_batch(self, job_descs: list, resumes: list) -> list:
        job_tok = self.tokenizer(job_descs, padding="max_length", truncation=True, max_length=config.MAX_LEN, return_tensors="tf")
        cv_tok = self.tokenizer(resumes, padding="max_length", truncation=True, max_length=config.MAX_LEN, return_tensors="tf")
